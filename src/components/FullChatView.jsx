              ...
              >
                ...
                {msg.sender === "bot" && msg.suggestions && msg.suggestions.length > 0 && (
                  <div className="pt-1 space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-200">
                    <div className="flex items-center gap-1.5 text-[11.5px] font-semibold text-[#9f7a35]">
                      <Sparkles className="w-3.5 h-3.5 text-[#d0aa61]" />
                      <span>Gợi ý câu hỏi đào sâu tiếp theo:</span>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {msg.suggestions.map((sug, sIdx) => (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-[#fcf8f0] hover:bg-[#f5ebd6] text-[#78591a] border border-[#d0aa61]/45 hover:border-[#d0aa61] rounded-full transition-all duration-150 hover:shadow-xs cursor-pointer active:scale-[0.98] text-left"
                        >
                          <ArrowRight className="w-3 h-3 text-[#d0aa61] shrink-0" />
                          <span>{sug}</span>
                        </button>
                      ))}
                    </div>
