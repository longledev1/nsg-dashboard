...
- 📄 **Tài liệu tham khảo**: Trích dẫn tên tài liệu để người đọc tiện tra cứu.
`.trim(),
...
5. ĐÍNH KÈM THẺ TRÍCH DẪN TÀI LIỆU:
   - Ở dòng cuối cùng của câu trả lời, hãy ghi rõ: [TÀI LIỆU: tên_tệp_chính_xác.docx]. 
